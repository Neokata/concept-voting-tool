  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2">
        <Link
          href="/join"
          className="group rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition hover:border-zinc-400 hover:shadow"
        >
        ...
        <Link
          ...
          className="group rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition hover:border-zinc-400 hover:shadow"
        >
          <h2 className="text-xl font-semibold">Open admin</h2>
          <p className="mt-2 text-sm text-zinc-600">
